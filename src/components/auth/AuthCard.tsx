...
export function AuthCard({ title, highlight, subtitle, children }: AuthCardProps) {
    return (
        <div className="max-w-md mx-auto mt-8 px-4 pb-safe-auth">
            <div className="bg-surface/40 backdrop-blur-xl p-6 sm:p-8 rounded-[2.5rem] border-brand-subtle shadow-2xl relative overflow-hidden">
                {/* Decorative background element */}
                <div className="absolute -top-24 -right-24 w-48 h-48 bg-accent/5 blur-[80px] rounded-full" />
                
                <div className="text-center mb-6 relative">
                    <div className="inline-flex items-center justify-center w-14 h-14 bg-accent/10 rounded-2xl mb-4 transform rotate-3 hover:rotate-0 transition-transform duration-500">
